...
public class LList2<T> implements ListInterface<T>
{
  ...
  /*
     Fix the LList2.java display method and complete the remove(T anEntry) method (from the Linked List Code Files link) under Week 1 in Catalyst so they work correctly with the doubly-linked list using dummy head and dummy tail nodes instance variables.  Remember, don't display nor delete the data (item) of the firstDummyNode and lastDummyNode.  In display, DON'T change any instance variables and don't change anything in the nodes.
  */
  public boolean remove(T anEntry){
   ...
   // UPDATED***************
   // If the givenPosition < 1, return firstDummyNode
   // If the givenPosition > numberOfEntries, return
   //               lastDummyNode.
