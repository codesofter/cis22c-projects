...
public class LList<T> implements ListInterface<T>
{
  ...
  {
    // If bad input received, return false immediately.
    if(anEntry == null){
      return false;
    }
    ...
    // System.out.println("anEntry: " + anEntry);
    ...
    if(anEntry.equals(firstNode.getData())){
      ...
      currentNode = firstNode.getNextNode(); // Start from index 2
      ...
      */
      while(currentNode != null){
        // System.out.println("checking node: " + currentNode.getData());
        if(anEntry.equals(currentNode.getData())){
          ...
          if(currentNode != null && nodeAfter != null){
            ...
            // If the node to be removed is the last item of the list, set nodeAfter such that when the currentNode is removed, nodeBefore's nodeAfter will be set to `null`.
            nodeAfter = null;
          }
        }
      }
